...
<div class="ff-secfields">
  ...
  <div class="form-group ff-item  ff-text " id="ff-id-162186008">
    
      <label for="Widget162186008">
          Nama Anggota (yang dilaporkan) *opsional
          
          <i class="ff-editwidget material-icons" onclick="editFacade.showWidget('162186008')">settings</i>
      </label>
        ...
        <input type="text" class="form-control" id="Widget162186008" name="entry.140310129" value="" placeholder="">
      
    
    <div id="Error162186008" class="ff-widget-error"></div>
  </div>
